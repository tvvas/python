...
6. Пояснити кожен рядок коду. Функція setheading повертає "черепашку" на потрібіний кут, інформацію по цій функції можна знайти тут https://www.pythonsandbox.com/docs/turtle
