...
4. Відкрити код із попередньої роботи
5. Додати ще одне текстове поле. Таким чином має бути два текстові поля
...
4. Відкрити код із попередньої роботи
5. Змінити назву кнопки "Коло" на "Прямокутник"
6. Зробити так, щоб при натисканні на кнопку "Прямокутник" було побудовано прямокутник із довжиною, введеною у перше текстове поле, і шириною, введеною у друге текстове поле
7. Продемонструвати роботу програми
8. Пояснити кожен рядок коду
