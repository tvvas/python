...
1. Відкрити код із попередньої роботи
2. Додати ще одне текстове поле. Таким чином має бути два текстові поля
3. Зробити так, щоб при натисканні на кнопку "Коло" було побудоване коло із радіусом, введеним у друге текстове поле
4. Продемонструвати роботу програми
5. Пояснити кожен рядок коду
...
1. Відкрити код із попередньої роботи
2. Змінити назву кнопки "Коло" на "Прямокутник"
3. Зробити так, щоб при натисканні на кнопку "Прямокутник" було побудовано прямокутник із довжиною, введеною у перше текстове поле, і шириною, введеною у друге текстове поле
4. Продемонструвати роботу програми
5. Пояснити кожен рядок коду
